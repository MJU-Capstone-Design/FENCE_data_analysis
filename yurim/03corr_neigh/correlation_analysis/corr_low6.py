...
def read_data():
    ...
    rest_restaurant = pd.read_csv(
        './data/rest_restaurant3.csv', encoding='euc-kr')
    restaurant = pd.read_csv(
        './data/df_seoul_restaurant_l.csv', encoding='euc-kr')
    park = pd.read_csv('./data/df_seoul_park.csv', encoding='euc-kr')
    rate = pd.read_csv('./data/secure_7.csv', dtype={'전체': int, '살인': int, '강도': int, '절도': int,
